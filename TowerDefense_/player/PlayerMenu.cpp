...
void PlayerMenu::render(sf::RenderWindow& window, const Player& player)
{
    ...
    mAttackRangeCircle.setPosition(player.getPosition().x + 10, player.getPosition().y + 10);
    mPlacementRangeCircle.setPosition(player.getPosition().x + 10, player.getPosition().y + 10);
