...
MiraStanton::MiraStanton(const sf::Vector2f& position)
    ...
    mGreeting1Dialogue.addSegment(DialogueSegment("Alden! There you are!"));
    mGreeting1Dialogue.addSegment(DialogueSegment("I was just thinking about that shortcut we found through the forest last week."));
    mGreeting1Dialogue.addSegment(DialogueSegment("You up for another adventure? Or maybe just a quick run to gather supplies?"));
    mGreeting1Dialogue.addSegment(DialogueSegment("You know me, I can't sit still for too long!"));
