...
GarrickStone::GarrickStone(const sf::Vector2f& position, GameManager* gameManager)
    ...
    mGreeting1Dialogue.addSegment(DialogueSegment("Alden. You're here early. Good!"));
    mGreeting1Dialogue.addSegment(DialogueSegment("The village needs more people who aren't afraid to get their hands dirty."));
    mGreeting1Dialogue.addSegment(DialogueSegment("I've got a task for you , if you're up for it"));
    mGreeting1Dialogue.addSegment(DialogueSegment("Nothing too dangerous... yet. But it'll help you learn the ropes."));
    mGreeting1Dialogue.addSegment(DialogueSegment("The village doesn't defend itself, after all."));
